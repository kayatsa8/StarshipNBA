package com.starship.nbamicroservice.model.game_statistics;
...
@JsonCreator
    public Statistic(@JsonProperty("fastBreakPoints") int fastBreakPoints,
                     @JsonProperty("pointsInPaint") int pointsInPaint,
                     @JsonProperty("biggestLead") int biggestLead,
                     @JsonProperty("secondChancePoints") int secondChancePoints,
                     @JsonProperty("pointsOffTurnovers") int pointsOffTurnovers,
                     @JsonProperty("longestRun") int longestRun,
                     @JsonProperty("points") int points,
                     @JsonProperty("fgm") int fgm,
                     @JsonProperty("fga") int fga,
                     @JsonProperty("fgp") String fgp,
                     @JsonProperty("ftm") int ftm,
                     @JsonProperty("fta") int fta,
                     @JsonProperty("ftp") String ftp,
                     @JsonProperty("tpm") int tpm,
                     @JsonProperty("tpa") int tpa,
                     @JsonProperty("tpp") String tpp,
                     @JsonProperty("offReb") int offReb,
                     @JsonProperty("defReb") int defReb,
                     @JsonProperty("totReb") int totReb,
                     @JsonProperty("assists") int assists,
                     @JsonProperty("pFouls") int pFouls,
                     @JsonProperty("steals") int steals,
                     @JsonProperty("turnovers") int turnovers,
                     @JsonProperty("blocks") int blocks,
                     @JsonProperty("plusMinus") String plusMinus,
